...
public struct YaCht_CardData
{
    ...
    public int m_cost;
    public YaCht_CardType m_cardType;
    public string m_description;
    
    // 데미지 계산 함수
    public Func<YaCht_CardData, YaCht_TargetState, float> m_damageCalculator;
    public Action<YaCht_CardData, YaCht_TargetState> m_abilityTrigger;
}

// 대상 상태를 담을 (데미지 계산에 필요한 정보)
public class YaCht_TargetState
{
