...
public class YaCht_WWESelectCard : MonoBehaviour, IPointerClickHandler
{
    ...
    public void Init(YaCht_CardData cardData)
    {
        m_cardData = cardData;
        UpdateCardUI();
    ...
    public void UpdateCardData(YaCht_CardData cardData)
    {
        m_cardData = cardData;
        UpdateCardUI();
    }
    ...
    {
        YaCht_CardSelectScene selectScene = FindFirstObjectByType<YaCht_CardSelectScene>();
        if (selectScene != null)
        {
